...
class RunModel(Model):
    ...
    def define(self):
        ...
        self.create_input(name='propeller_radius', shape=(1, ), units='m', val=1.25)
        self.create_input(name='chord_profile', shape=(num_radial,), units='m', val=np.linspace(0.5,0.15,num_radial))
        self.create_input(name='twist_profile', shape=(num_radial,), units='rad', val=np.linspace(50,15,num_radial)*np.pi/180)
