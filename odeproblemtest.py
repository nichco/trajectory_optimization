...
class ODEProblemTest(ODEProblem):
    def setup(self):
        ...
        self.add_state('v', 'dv', initial_condition_name='v_0', output='v', interp_guess=[1, 50])
        ...
        self.add_state('x', 'dx', initial_condition_name='x_0', output='x', interp_guess=[1, 3450])
        self.add_state('e', 'de', initial_condition_name='e_0', output='e', interp_guess=[1, 1300])
