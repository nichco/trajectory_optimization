...
import numpy as np
from rotors.cruise_rotor_explicit import cruiseRotorModel

class cruiseRotor(csdl.Model):
    def initialize(self):
    ...
    def define(self):
        ...
        self.add(cruiseRotorModel(name=name,num_nodes=num), name='cruiseRotorModel')
...
if __name__ == '__main__':
    ...
    name = 'cruise'
    sim = python_csdl_backend.Simulator(cruiseRotor(options=options,name=name,num_nodes=10))
    sim.run()
