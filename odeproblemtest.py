...
class ODEProblemTest(ODEProblem):
    def setup(self):
        ...
        self.add_parameter('control_theta', dynamic=True, shape=(self.num_times))
        # self.add_parameter('control_x', dynamic=True, shape=(self.num_times))
        self.add_parameter('interp_x', dynamic=True, shape=(self.num_times))
        ...
        self.add_profile_output('liftct')
        self.add_profile_output('cruisect')
